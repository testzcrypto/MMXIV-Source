...
uint256 hashGenesisBlock("0x000000008fb64526f2a638f11547b5f11b1e6b5064dbff3fcbb33892ce5db283");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 1007 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 1007);
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x000000008fb64526f2a638f11547b5f11b1e6b5064dbff3fcbb33892ce5db283");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        block.nVersion = 1;
        block.nTime    = 1400913141;
        block.nBits    = 486604799;
        block.nNonce   = 3129385391;
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("MMXIVMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("MMXIVMiner : ProcessBlock, block not accepted");
    }
...
void static BitcoinMiner(CWallet *pwallet)
{
    ...
    try { loop {
        ...
        printf("Running MMXIVMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
