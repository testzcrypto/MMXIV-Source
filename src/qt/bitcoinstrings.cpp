...
QT_TRANSLATE_NOOP("bitcoin-core", ""
"Unable to bind to %s on this computer. MMXIV is probably already running."),
QT_TRANSLATE_NOOP("bitcoin-core", ""
...
QT_TRANSLATE_NOOP("bitcoin-core", "SSL options: (see the MMXIV Wiki for SSL setup instructions)"),
